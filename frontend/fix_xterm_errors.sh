...
echo "🔧 ИСПРАВЛЕНИЕ XTERM ОШИБОК"
echo "==========================="

# Удалить deprecated пакеты и установить новые
echo "📦 Переустанавливаем XTerm с актуальными пакетами..."
npm uninstall xterm xterm-addon-fit xterm-addon-web-links
npm install @xterm/xterm @xterm/addon-fit @xterm/addon-web-links

echo "✅ Актуальные XTerm пакеты установлены"

# Исправить XTermTerminal.tsx
...
echo "✅ XTermTerminal.tsx исправлен"

# Обновить Vite конфиг для новых пакетов
...
echo "✅ Vite config обновлен для новых пакетов"

# Тестировать сборку
echo "🧪 Тестируем исправленный XTerm..."
npm run build

if [ $? -eq 0 ]; then
    echo "✅ Все ошибки исправлены! XTerm терминал готов"
    echo "🎯 Используются актуальные пакеты @xterm/*"
    echo "📦 Demo режим с улучшенными командами"
else
